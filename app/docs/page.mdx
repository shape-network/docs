...
Shape is [EVM equivalent](/docs/building-on-shape/differences-ethereum-shape). This means your creator experience is the same as on Ethereum, just at a fraction of the cost.
...
Shape also prioritizes stability and scalability, utilizing [Alchemy](https://docs.shape.network/documentation/building-on-shape/alchemy) and [Optimism](https://www.optimism.io/) as key infrastructure partners to help achieve and maintain these states.
