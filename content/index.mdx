...
Shape also prioritizes stability and scalability, utilizing [Alchemy](/building-on-shape/alchemy/alchemy-api) and [Optimism](https://www.optimism.io/) as key infrastructure partners to help achieve and maintain these states.
