...
Check [op-geth releases](https://github.com/ethereum-optimism/op-geth/releases) for the required release branch.
...
Check [optimism releases](https://github.com/ethereum-optimism/optimism/releases) for the required release branch.
