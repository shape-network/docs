...
We greatly welcome contributions to the project! Please reach out on [Discord](https://discord.com/invite/shape-L2) or [Twitter/X](https://x.com/shape) if you'd like to get involved.
...
const item = {
  ...
  imageUri: 'https://arweave.net/cBCEZ6bqtmdkS6Vj8dIAgXhl4O8oDSyAWuqCMlCDToU',
...
const testPick = {
  ...
  imageUri: 'https://arweave.net/D3uuvnLDY48wmJ_Qic5l3AUrQ1pfOaUYn79t9PJYG18',
  ...
  blueprint: [
    {
      componentType: 0, // ComponentType.OTOM
      itemIdOrOtomTokenId:
        '59556967404187678662646267921069430003902119556859655597906602022599940926148', // T15
      amount: 1,
      criteria: [],
    },
    {
      componentType: 0, // ComponentType.OTOM
      itemIdOrOtomTokenId:
        '103207475906385737307003328874764609497044818069100475897999853498353983732479', // Sr2
      amount: 2,
      criteria: [],
    },
  ],
