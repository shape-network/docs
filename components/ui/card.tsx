...
export const Card: FC<{
  ...
  return (
    <div className="rounded border border-neutral-200 bg-neutral-100 transition-colors hover:bg-neutral-100/25 dark:border-neutral-800 dark:bg-neutral-900 hover:dark:bg-neutral-900/50">
      <Link href={href}>
